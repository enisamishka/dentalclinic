        ...
        <main>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="admin-employees.php" style="color: #39b87d !important;">Employees</a></li>
                                ...
                                <form method="POST" id="employee_form" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" name="action" id="action" class="btn" style="background: #299462 !important;" value="Edit"/>
