...
<div class="main-content">
    ...
    <main>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="receptionist-dashboard.php"
                                               style="color: #39b87d !important;">Home</a></li>
                <li class="breadcrumb-item"><a href="receptionist-appointments.php" style="color: #39b87d !important;">Appointments</a>
                </li>
        ...
        <div class="card" style="margin-top: auto">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="today_table" class="table table-hover" style="background: #b6d6c7">
                        <thead>
                        <tr>
                            <th hidden>ID</th>
                            <th>Name</th>
                        ...
                        <?php } else {
                            foreach ($requests[0] as $request) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" value="" id="approve"
                                                data-toggle="modal" data-target="#approveModal">
                                            <i class='fas fa-check'></i>
                                        </button>
                                        <button type="button" class="btn btn-primary btn-sm" value="" id="reschedule"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form method="POST" action="controller/manage-requests.php">
                            ...
                            <button type="submit" class="btn btn-danger" id="modal_reject_button"
                                    name="modal_reject_button">Reject
                            </button>
                        </form>
                    </div>
                </div>
                        ...
                        <form method="POST" action="controller/manage-requests.php" class="border shadow p-3 rounded">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select form-select-lg mb-3" id="doctor_id"
                                            name="doctor_id">
                                        <?php
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-success" id="modal_approve_button"
                                        name="modal_approve_button">Confirm
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form method="POST" action="controller/manage-requests.php" class="border shadow p-3 rounded"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <label>Doctor</label>
                                    <select class="form-control form-select form-select-lg mb-3" id="doctor_r"
                                            name="doctor_id">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-success" id="modal_reschedule_button"
                                        name="modal_reschedule_button">Reschedule
                                </button>
                            </div>
                        </form>
                    </div>
