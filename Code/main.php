...
<section id="hero2" class="d-flex align-items-center">
    <div class="container">
        ...
        <h2>Bringing the cutest smile</h2>
    </div>
</section><!-- End Hero -->
...
<main id="main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        <h3>Beautiful smile... Better lifestyle!!</h3>
                        <p>
                            Smile Dental Clinic is a new generation clinic that has the ambition to combine the
                            professionalism and attention of the dentist with the most innovative technologies,
                            where you will find a welcoming environment that will make you feel aware of having
                            made the right choice for your smile.
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Miscroscopic Endodontics</a></h4>
                        <p>
                            Microscopic endodonzia, a morden technic of surgery
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <p>
                            The patient can receive single session general treatments.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Implantology</a></h4>
                        <p>
                            Dental implants are a procedure for replacing missing teeth.
                        </p>
                    </div>
                </div>
    ...
    <section id="doctors" class="doctors">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Doctors</h2>
                <p>Some of the best doctors in the field of dental surgery are part of our team.</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="member d-flex align-items-start">
                        ...
                        <div class="member-info">
                            <h4>Walter White</h4>
                            <span>Orthodontists & Pediatrics</span>
                            <div class="social">
                ...
                <div class="col-lg-6 mt-4 mt-lg-0">
                    <div class="member d-flex align-items-start">
                        ...
                        <div class="member-info">
                            <h4>Chandler Bing</h4>
                            <span>Odontoiatria Estetica & Implantologia</span>
                            <div class="social">
                                <a href=""><i class="ri-twitter-fill"></i></a>
                                <a href=""><i class="ri-facebook-fill"></i></a>
                                <a href=""><i class="ri-instagram-fill"></i></a>
                ...
                <div class="col-lg-6 mt-4">
                    <div class="member d-flex align-items-start">
                        ...
                        <div class="member-info">
                            <h4>Monica Geller</h4>
                            <span>Odontoiatria Estetica</span>
                            <div class="social">
                                <a href=""><i class="ri-twitter-fill"></i></a>
                                <a href=""><i class="ri-facebook-fill"></i></a>
                                <a href=""><i class="ri-instagram-fill"></i></a>
                ...
                <div class="col-lg-4">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>
                                Smile Dental Clinic Bulevardi Dyrrah, Durrës 2001
                            </p>
                        </div>
                        ...
                        <div class="email">
                            ...
                            <h4>Email:</h4>
                            <p>info@smiledentalclinic.com</p>
                        </div>

                        <div class="phone">
                            <i class="bi bi-phone"></i>
                            <h4>Call:</h4>
                            <p>+355 69 33 33 333</p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        ...
                        Bulevardi Dyrrah,<br>
                        Durres 2001<br><br>
                        <strong>Phone:</strong> +355 69 33 33 333<br>
                        <strong>Email:</strong> info@smiledentalclinic.com <br>
                    </p>
                </div>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="#services">Dental Radiology</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#services">Orthodontics</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#services">Implantology</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#services">Dental Prostheses</a></li>
                    </ul>
                </div>
