    ...
    <div class="main-content">
        ...
        <header>
            <div class="navbar navbar-dark">
                <a href="receptionist-dashboard.php" class="logo me-auto"><img src="assets/images/logo.png"
                                                                               alt="Clinic Logo" class="img-fluid"></a>
        ...
        <main>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="receptionist-dashboard.php" style="color: #39b87d !important;">Home</a>
                    </li>
            ...
            <div class="card" style="margin-top: auto">
                        ...
                        <div class="col-sm-3" align="right">
                            <?php if ($_SESSION['role'] == 'receptionist') {
                                ...
                                <button type="submit"
                                        class="btn"
                                        data-toggle="modal"
                                        style="background: #299462 !important; color: white"
                ...
                <div class="card-body">
                    <!--  Patient Table-->
                    <div class="w-100">
                        <table id="patient_table" class="display table" style="background: #6ca68b">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" name="action" id="action" class="btn"
                                       style="background: #299462 !important;" value="Add"/>
                            ...
                            <form method="POST" action="doctor-healthrecords.php" class="border shadow p-3 rounded">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" id="modal_approve_button"
                                            name="modal_approve_button">View
                                    </button>
                                </div>
                            </form>
                        </div>
